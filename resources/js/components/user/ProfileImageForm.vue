<template>
  <div class="card card-profile-image">
    ...
    <div class="card-body d-flex justify-content-center align-items-center painter-mypage-profile-image" :style="{ backgroundImage: 'url(' + this.compSrc + ')' }" @click="onClickRegister">
