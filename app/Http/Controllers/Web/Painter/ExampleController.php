...
class ExampleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(config('const.template.painter.example'), ['createBtnDisable' => $createBtnDisable]);
    }
    ...
    public function create()
    {
        ...
        return view(config('const.template.painter.example_create'));
    }
    ...
    public function edit($id)
    {
        ...
        return view(config('const.template.painter.example_edit'), ['example' => $example]);
    }
}
